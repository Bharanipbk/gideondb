...
func documentationDocumentOrder(name string) int {
	order := map[string]int{
		...
		"operations/aws-ecs-storage-plan.md":       4,
		"operations/production-deployment-plan.md": 5,
		"operations/dashboard.md":                  6,
		"operations/observability.md":              7,
		"operations/backup-restore.md":             8,
		"operations/rolling-upgrades.md":           9,
		"operations/compatibility.md":              10,
		"operations/network-partitions.md":         11,
	}
